...
const routes = JSON.parse((0, node_fs_1.readFileSync)((0, node_path_1.join)(routesDir, "routes.json")).toString());
const builtInRoutes = JSON.parse((0, node_fs_1.readFileSync)((0, node_path_1.join)(routesDir, "builtin-routes.json")).toString());
// Functions
...
function getServerRes(ip) {
    return __awaiter(this, void 0, void 0, function* () {
        return new Promise(res => {
            node_http_1.default.get(`${ip}/health`, response => {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        switch (urls.length) {
            case 0:
                ...
                break;
            case 1:
                if ((yield getServerRes(httpify(urls[0].route))) === false) {
                    res.sendStatus(503);
